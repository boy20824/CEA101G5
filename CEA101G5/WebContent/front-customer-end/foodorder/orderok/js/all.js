...
//  );
  ...
  for(let i=0; i<status.length;i++){
	  setInterval(function() {
		    status[i].classList.remove("animate__fadeOutRightBig")
		    status[i].classList.add("animate__bounceInLeft")
		    
		    setTimeout(function() {
		    	status[i].classList.remove("animate__bounceInLeft")
		      status[i].classList.add("animate__shakeX") 
		      
		      
		      setTimeout(function() {
		    	  status[i].classList.remove("animate__shakeX")
		        status[i].classList.add("animate__fadeOutRightBig")
		      },1500) 
		    },2500)
		  },4500)
  }
