            ...
            <body>
                <div class="wrap">
                    ...
                    <div class="sign-up-container" style="background-image: url(<%=request.getContextPath()%>/front-customer-end/restaurant/img/application.png);">
                        <div class="thanks-text" style="top:40%;">您已申請成功，請靜候管理員審核</div>
                    </div>
                    ...
                    <div class="footer">
                        <div class="footer-image">
                            <img src="<%=request.getContextPath()%>/front-customer-end/restaurant/img/LOGO/Logo3 (2).png" alt="" />
                            <div class="footer-image-bottom">
                                <img src="<%=request.getContextPath()%>/front-customer-end/restaurant/img/ICON/fb.png" alt=""> <img src="<%=request.getContextPath()%>/front-customer-end/restaurant/img/ICON/tw.png" alt=""> <img src="<%=request.getContextPath()%>/front-customer-end/restaurant/img/ICON/ig.png" alt="">
                            </div>
                        </div>
