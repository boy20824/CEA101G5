...
<body>
	<div class="wrap">
		...
		<div class="sign-up-container"
			style="background-image: url(<%=request.getContextPath()%>/front-customer-end/restaurant/img/application.png);">

			<div class="envelope">
				<div class="paper">
					<h1>請輸入您餐廳統一編號</h1>
					<form METHOD="post" class="sign-up-form">
						<input class="text-input" type="text" name="memLice"
							value="${param.memLice}" /> <input type="hidden" name="memPhone"
							value="${memLogin.memPhone}"> <input type="hidden"
							name="memCondition" value="3"> <input type="hidden"
							name="action" value="updateMemLice">
						<button class="button" type="submit"
							onClick="validateForm(this.form)">送出</button>
					</form>
				</div>
				<div class="bottom-flap"></div>
			</div>
			<div class="thanks-text" style="display: none">
				<span>您已申請成功，請靜候管理員審核</span>
			</div>
		</div>
