...
<body>
	<div class="wrap">
		...
		<div class="forfiexed">
			<ul class="title">
				<li><img class="side-menu-p"
					src="<%=request.getContextPath()%>/front-customer-end/front/img/ICON/hambugers.png"
					alt="menu" /></li>
				<li><a
		...
		<div id="joinSuccess">
			<img
				src="<%=request.getContextPath()%>/front-customer-end/member/img/ICON/Join_success.png">
			<p>歡迎加入Enak</p>
		</div>
		<div id="joinSuccessBtn">
			<input type="botton" class="successSubmit" value="立刻登入"
				onclick="location.href='<%=request.getContextPath()%>/front-customer-end/member/MemLogin.jsp'">
			<input type="botton" class="successSubmit" value="回到首頁"
				onclick="location.href='<%=request.getContextPath()%>/front-customer-end/front/front.jsp'">
		</div>
