...
<body>
	<div class="wrap">
		...
		<div class="forfiexed">
			<ul class="title">
				<li><img class="side-menu-p" src="<%=request.getContextPath()%>/front-customer-end/member/img/ICON/hambugers.png"
					alt="menu" /></li>
				<li><a
			...
			<table id="memberPageTable">
				...
				<tr>
					...
					<td><img width=100 height=100
						src="<%=request.getContextPath()%>/back-end/member/memPhotoReader.do?memPhone=${memLogin.memPhone}"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" name="memPwd" size="45"
						value="${memLogin.memPwd}" readonly /></td>
				</tr>

				<tr>
					<td>姓名:</td>
					<td><input type="TEXT" name="memName" size="45"
						value="${memLogin.memName}" readonly /></td>
				</tr>

				<tr>
					<td>地址:</td>
					<td><input type="TEXT" name="memAddress" size="45"
						value="${memLogin.memAddress}" readonly /></td>
				</tr>
				...
				<tr>
					...
					<td><input type="email" name="memEmail" size="45"
						value="${memLogin.memEmail}" readonly /></td>
				</tr>
				...
				<tr>
					...
					<input type="submit" value="修改會員資料" id="toUpdate">
					<input type="hidden" name="comeFrom" value="fromMemberPage">
