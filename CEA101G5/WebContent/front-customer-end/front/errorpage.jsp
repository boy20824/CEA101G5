...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
  ...
  <div class="onlyforchrome" style="font-size: 30px;font-family: Helvetica;">無法連上網際網路</div>
  <div style="font-size: 16px;">建議作法:
  <ul style="font-size: 16px;">
  	...
  	<li style="color: #8879D8;">
  	執行Windows網路診斷
  	</li>
  	
  </ul>
   <div class="onlyforchrome" style="font-size: 12px;font-family: Helvetica;">
