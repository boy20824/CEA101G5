        ...
        <nav id="homeNavBar" class="navbar navbar-expand-lg navbar-light bg-warning">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <img src="shared/user2.svg" alt="" id="navbarUserIcon">
                            <!-- <a class="nav-link active" aria-current="page" href=""><img src="/images/user2.svg" alt=""
                                id="navbarUserIcon"></a> -->
                        </li>
                        <li class="nav-item">
                            <img src="shared/cart3.svg" alt="" id="navbarCartIcon">
    ...
    <div id="signInMain" class="signInBackground">
        <div id="signInContainer" class="container">
            ...
            <main class="form-signin">
                <form>
                    <img class="mb-4" src="shared/logoMain2.png" alt="" width="125" height="125">
