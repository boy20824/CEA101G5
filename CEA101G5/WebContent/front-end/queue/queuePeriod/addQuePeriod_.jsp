...
<table>
	...
	<tr>
		<td>status:</td>
		<td><input type="TEXT" name="queuest" size="45"
			 value="<%= (quePeriodVO==null)? "1" : quePeriodVO.getQueuest()%>" /></td>
	</tr>
	<tr>
		<td>start日期:</td>
		<td><input name="queuestarttime" class="q_date" id="f_date1" type="text"></td>
	</tr>
	<tr>
		<td>end日期:</td>
		<td><input name="queueendtime" class="q_date" id="f_date1" type="text"></td>
	</tr>
	<tr>
		<td>nocurrent:</td>
