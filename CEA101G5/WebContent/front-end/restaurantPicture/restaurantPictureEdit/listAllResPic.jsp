...
<table>
	...
	<c:forEach var="restaurantPictureVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td><img style="width:100px;" src="<%=request.getContextPath() %>/front-end/restaurantPicture/restaurantPictureEdit/restaurantPictureEdit.do?storePicId=${restaurantPictureVO.storePictureId}&action=getOne_For_Display"></td>
			
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/restaurantPicture/restaurantPictureEdit/restaurantPictureEdit.do" style="margin-bottom: 0px;">
