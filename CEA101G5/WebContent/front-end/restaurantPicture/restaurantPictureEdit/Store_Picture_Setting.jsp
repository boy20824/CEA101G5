...
<%
    RestaurantPictureService storePicSvc = new RestaurantPictureService();
    List<RestaurantPictureVO> list = storePicSvc.getAll();
...
<html>
  ...
  <body>
    ...
    <div id="main">
        <div id="left">
          <div id="left_top">
            <img src="image/p1.jpg" alt="" id="1" onclick="showBig()">
            <img src="image/p2.jpg" alt="" id="2" onclick="showBig()">
            <img src="image/p3.jpg" alt="" id="3" onclick="showBig()">
            <img src="image/p4.jpg" alt="" id="4" onclick="showBig()">
            <img src="image/p1.jpg" alt="" id="1" onclick="showBig()">
            <img src="image/p2.jpg" alt="" id="2" onclick="showBig()">
            <img src="image/p3.jpg" alt="" id="3" onclick="showBig()">
            <img src="image/p4.jpg" alt="" id="4" onclick="showBig()">
          </div>
          <div id="left_bot">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur nobis, vel nemo ipsa consectetur iste similique voluptate quidem exercitationem tempora architecto hic, inventore repudiandae. Exercitationem iure est accusantium nemo debitis.</div>
        </div>
        <div id="right">
    ...
    <script>
      ...
      function showBig() {
          var picinfo = "image/p" + event.target.id + ".jpg";
          // alert(picinfo);
