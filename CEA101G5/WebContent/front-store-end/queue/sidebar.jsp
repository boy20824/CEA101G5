...
<body>
	...
	<div id="mySidebar" class="sidebar">
		...
		<p>餐廳</p>
			...
			<p>外帶</p>
		</span> <span> <a href="<%=request.getContextPath()%>/front-store-end/queue/queueNo/queueNo.do?action=storeGetQueNo&storeid=${storeLogin.storeId}"><svg aria-hidden="true" focusable="false"
		...
		</span>  <span> <a href="<%=request.getContextPath()%>/front-store-end/acceptreserve/listAllAcceptReserve.jsp"><svg aria-hidden="true" focusable="false"
