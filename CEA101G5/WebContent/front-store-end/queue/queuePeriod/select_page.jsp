...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/store_font/css/css.css" />
    <meta
      name="viewport"
  ...
  <body>
    <div id="mySidebar" class="sidebar">
      ...
      <span>
        <svg
          ...
          class="svg-inline--fa fa-concierge-bell fa-w-16"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <span>
        <svg
          ...
          viewBox="0 0 640 512"
        >
          <a href="<%=request.getContextPath()%>/quePeriod/select_page.jsp">
            <path
              fill="#9C9C9C"
    ...
    <div id="main">
      <div id="main_left">
        ...
        <div id="pickup_btn">
          <button id="pickupNo_btn">新增取號資料</button>
        </div>
      </div>

      <div id="main_right">
        <div class="queline" id="line1">
          <div class="lineleft" id="line1left">
          ...
          <div class="lineright" id="line1right">
            <button class="call" id="call1">叫號</button>
            <button class="clear" id="clear1">收桌</button>
          </div>
        </div>
        <div class="queline" id="line2">
          <div class="lineleft" id="line2left">
          ...
          <div class="lineright" id="line2right">
            <button class="call" id="call2">叫號</button>
            
            <button class="clear" id="clear2">收桌</button>
          </div>
        </div>
        <div class="queline" id="line3">
          <div class="lineleft" id="line3left">
          ...
          <div class="lineright" id="line3right">
            <button class="call" id="call3">叫號</button>
            <button class="clear" id="clear3">收桌</button>
          </div>
        </div>
        <div class="queline" id="line4">
          <div class="lineleft" id="line4left">
          ...
          <div class="lineright" id="line4right">
            <button class="call" id="call4">叫號</button>
            <button class="clear" id="clear4">收桌</button>
          </div>
        </div>
      </div>
    </div>
