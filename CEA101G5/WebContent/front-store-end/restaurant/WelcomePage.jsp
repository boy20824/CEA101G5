...
<%@include file="../selectpage/selectstorepage.jsp" %>
    ...
    <body>
        ...
        <div class="welcomePageBtn">
            ...
            <button type="submit" onclick="location.href='<%=request.getContextPath()%>/front-store-end/queue/queueNo/queueNo.do?action=storeGetQueNo&storeid=${storeLogin.storeId}'">取號管理</button>
