...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <body>
        ...
        <div id="mySidebar" class="sidebar">
			...
			<ul>
				<li>餐廳設定
					...
					<c:if test="${not empty sessionScope.storeLogin}">
						...
						<li><a href="<%=request.getContextPath()%>/front-store-end/restaurant/RestaurantPicturePage.jsp">餐廳照片管理</a></li>
						<li>功能開關選項</li>
					</ul>
				</li>
				<li>餐點設定
            ...
            <span> <a href="<%=request.getContextPath()%>/front-store-end/queue/queueNo/storeWelcome.jsp"><svg aria-hidden="true" focusable="false" id="numPickup"
