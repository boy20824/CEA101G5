...
public class RestaurantVO implements java.io.Serializable{
	...
	private Integer storePeoplepTotal;
	...
	public Integer getStorePeoplepTotal() {
		return storePeoplepTotal;
	}

	public void setStorePeoplepTotal(Integer storePeoplepTotal) {
		this.storePeoplepTotal = storePeoplepTotal;
	}
