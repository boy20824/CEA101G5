...
public class QueTableServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if("list_One_Store".equals(action)) {
			...
			String url = "/front-end/queue/queueTable/editQueTable.jsp";
		...
		if("getOne_For_Display".equals(action)) {
			...
			req.setAttribute("queTableVO",queTableVO);
			String url = "/front-end/queue/queueTable/listOneQueTable.jsp";
			RequestDispatcher successView = req.getRequestDispatcher(url);
			successView.forward(req, res);
...
//			String queuetabletype = req.getParameter("queuetabletype");
			...
			RequestDispatcher successView = req.getRequestDispatcher(url);
			successView.forward(req, res);
//			String url = "/front-end/queue/queueTable/select_page.jsp";
//			RequestDispatcher successView = req.getRequestDispatcher(url);
			successView.forward(req, res);
			}catch (Exception e) {
				errorMsgs.add(e.getMessage());
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/queue/queueTable/select_page.jsp");
		...
		if("delete".equals(action)) {
			...
			successView.forward(req, res);
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/queue/queueTable/editQueTable.jsp");
				failureView.forward(req, res);
			}
		}
