...
//			orderDetailService.addOrderDetail(5, "ENP0009", 799, 4, "代刚蝶基", productReviewPhoto, 1);
...
//		try {
//			byte[] productReviewPhoto = getPictureByteArray("/Users/jordan/desktop/cat.png");
//			orderDetailService.updateOrderDetail(5, "ENP0001", 1000, 1000, "代刚蝶基XX", productReviewPhoto, 1);
//			System.out.println("Statement Processed...");
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
