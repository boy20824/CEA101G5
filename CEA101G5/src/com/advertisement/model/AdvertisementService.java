...
//		testing : addAd()
		try {
			...
			advertisementService.addAd("ENP0010", "代刚約肈", "代刚約ず甧", productReviewPhoto, java.sql.Date.valueOf("2020-12-01"), java.sql.Date.valueOf("2020-12-31"), 1);
...
//		try {
//			byte[] productReviewPhoto = getPictureByteArray("/Users/jordan/desktop/cat.png");
//			advertisementService.updateAd(1, "ENP0009", "代刚約肈", "代刚約ず甧", productReviewPhoto, java.sql.Date.valueOf("2020-12-01"), java.sql.Date.valueOf("2020-12-31"), 1);
//			System.out.println("Statement Processed...");
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
